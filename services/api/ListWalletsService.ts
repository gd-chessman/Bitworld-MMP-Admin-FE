...
export const getListWallets = async (search: string = '', page: number = 1, limit: number = 10, walletAuth: string = '', walletType: string = '', isBittworld?: boolean, bittworldUid?: string) => {
  try {
